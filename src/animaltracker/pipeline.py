                    ...
                    if existing_tracker:
                        ...
                        worker.ptz_tracker = create_ptz_tracker(
                            ...
                            config={
                                ...
                                'visibility_recovery_enabled': getattr(ptz_cfg, 'visibility_recovery_enabled', True),
                                'visibility_recovery_min_overlap': getattr(ptz_cfg, 'visibility_recovery_min_overlap', 0.50),
                                'visibility_recovery_edge_margin': getattr(ptz_cfg, 'visibility_recovery_edge_margin', 0.12),
                                'visibility_recovery_zoom_out_velocity': getattr(ptz_cfg, 'visibility_recovery_zoom_out_velocity', -0.25),
                                'visibility_recovery_zoom_in_velocity': getattr(ptz_cfg, 'visibility_recovery_zoom_in_velocity', 0.15),
                                'visibility_recovery_zoom_in_max_zoom': getattr(ptz_cfg, 'visibility_recovery_zoom_in_max_zoom', 0.35),
                                'visibility_recovery_zoom_in_fill_threshold': getattr(ptz_cfg, 'visibility_recovery_zoom_in_fill_threshold', 0.03),
                                'visibility_recovery_velocity_cap': getattr(ptz_cfg, 'visibility_recovery_velocity_cap', 0.20),
